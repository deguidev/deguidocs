---
title: 4. Notación UML para Diagramas Entidad-Relación
description: Sintaxis específica de UML para crear diagramas entidad-relación efectivos
---
...
<Aside type="tip">
  La notación UML para diagramas ER permite crear documentación técnica precisa que puede servir como base para la implementación de la base de datos.
</Aside>
